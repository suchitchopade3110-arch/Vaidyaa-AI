...
def _coerce_report_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "findings": data.get("findings") or classification.get("findings") or classification.get("all_findings") or [],
        "gradcam_path": data.get("gradcam_path") or (data.get("gradcam") or {}).get("heatmap_path"),
        ...
        "sources": data.get("sources") or data.get("source_citations") or data.get("citations") or data.get("radiology_evidence") or [],
        "citations": data.get("sources") or data.get("source_citations") or data.get("citations") or [],
        "radiology_evidence": data.get("radiology_evidence") or [],
