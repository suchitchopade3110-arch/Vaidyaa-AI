...
// ─── ConfidenceMeter ─────────────────────────────────────────────────────────
export function ConfidenceMeter({ value = 0, label = 'Confidence' }: { value?: number, label?: string }) {
...
// ─── PipelineStepper ─────────────────────────────────────────────────────────
export function PipelineStepper({ steps, currentStep }: { steps: Array<{label: string, desc?: string}>, currentStep: number }) {
  return (
...
// ─── FileUploadZone ───────────────────────────────────────────────────────────
export function FileUploadZone({ accept, acceptLabel, onFile, file, error }: { accept?: string, acceptLabel?: string, onFile: (f: File) => void, file?: File | null, error?: string | null }) {
...
// ─── PatientIdField ───────────────────────────────────────────────────────────
export function PatientIdField({ value, onChange }: { value: string, onChange: (v: string) => void }) {
  return (
    <div>
...
// ─── CitationList ─────────────────────────────────────────────────────────────
export function CitationList({ citations = [] }: { citations?: Array<{title: string, source?: string, snippet?: string}> }) {
...
// ─── EmptyResultState ─────────────────────────────────────────────────────────
export function EmptyResultState({ icon = '◫', title, subtitle }: { icon?: string, title: string, subtitle?: string }) {
  return (
...
// ─── ResultHeader ─────────────────────────────────────────────────────────────
export function ResultHeader({ status, jobId, elapsed }: { status: string, jobId?: string, elapsed?: string | number }) {
  const meta = STATUS_META[status] || STATUS_META.pending;
  return (
...
// ─── SegmentedControl ─────────────────────────────────────────────────────────
export function SegmentedControl({ options, value, onChange }: { options: Array<{label: string, value: string}>, value: string, onChange: (v: string) => void }) {
  return (
    <div style={{
...
// ─── Button ──────────────────────────────────────────────────────────────────
export function Button({ children, onClick, variant = 'primary', disabled = false, style = {} }: { children: React.ReactNode, onClick?: () => void, variant?: 'primary' | 'ghost', disabled?: boolean, style?: React.CSSProperties }) {
...
// ─── EntityChip ───────────────────────────────────────────────────────────────
export function EntityChip({ label, type }: { label: string, type?: 'condition' | 'medication' | 'lab_value' | 'finding' | string }) {
