// Ported from ui/shared.jsx — atomic UI components for VAIDYAA AI.
//
// Mechanical port: the bare `{ ... }` block scope and `Object.assign(
// window, {...})` are gone (real ES modules export instead), and
// `const { useState, ... } = React` is now a real import. Component
...
// ─── PipelineStepper ─────────────────────────────────────────────────────────
export function PipelineStepper({ steps, currentStep }) {
  return (
...
// ─── FileUploadZone ───────────────────────────────────────────────────────────
export function FileUploadZone({ accept, acceptLabel, onFile, file, error }) {
...
// ─── PatientIdField ───────────────────────────────────────────────────────────
export function PatientIdField({ value, onChange }) {
  return (
    <div>
...
// ─── UncertaintyBanner ────────────────────────────────────────────────────────
export function UncertaintyBanner({ message }) {
  return (
    <div style={{
...
// ─── EmptyResultState ─────────────────────────────────────────────────────────
export function EmptyResultState({ icon = '◫', title, subtitle }) {
  return (
...
// ─── ResultHeader ─────────────────────────────────────────────────────────────
export function ResultHeader({ status, jobId, elapsed }) {
  const meta = STATUS_META[status] || STATUS_META.pending;
  return (
...
// ─── EntityChip ───────────────────────────────────────────────────────────────
export function EntityChip({ label, type }) {
  const colors = {
