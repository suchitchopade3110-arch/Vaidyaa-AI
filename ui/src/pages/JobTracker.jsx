// Ported from ui/job-tracker.jsx — Job Tracker page.
//
// Uses mock/local data (ALL_JOBS below) exactly as the original did —
// this page never called the real API in the CDN-Babel version either,
// so there's no auth wiring needed here.
import React, { useState, useEffect, useRef } from "react";
import { Button, StatusBadge } from "../components/shared.jsx";
