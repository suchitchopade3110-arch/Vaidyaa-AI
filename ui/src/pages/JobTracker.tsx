...
function PollingDrawer({ job, onClose }: { job: any, onClose: () => void }) {
...
function TrackerRow({ job, last, onClick, onCancel }: { job: any, last: boolean, onClick: () => void, onCancel: () => void }) {
...
export default function JobTracker() {
  ...
  const tabCount = (tab: string) => tab === 'all' ? jobs.length : jobs.filter(j => j.type === tab).length;
