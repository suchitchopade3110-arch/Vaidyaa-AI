// Ported from ui/dashboard.jsx — Dashboard page component (wired to real API).
//
// The one real behavior change from the original: the jobs fetch now
// goes through apiFetch() (attaches the bearer token GET /api/v1/jobs
// requires per SEC-01/SEC-02) instead of a bare fetch() that would 401.
// The /health check stays a plain fetch — that endpoint has no auth.
import React, { useState, useEffect } from "react";
import { MedicalDisclaimer, StatusBadge } from "../components/shared.jsx";
